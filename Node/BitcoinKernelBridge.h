...
BTCK_SWIFT_CONSTANT(btck_BlockValidationResult_UNSET)
BTCK_SWIFT_CONSTANT(btck_BlockValidationResult_CONSENSUS)
BTCK_SWIFT_CONSTANT(btck_BlockValidationResult_CACHED_INVALID)
BTCK_SWIFT_CONSTANT(btck_BlockValidationResult_INVALID_HEADER)
BTCK_SWIFT_CONSTANT(btck_BlockValidationResult_MUTATED)
BTCK_SWIFT_CONSTANT(btck_BlockValidationResult_MISSING_PREV)
BTCK_SWIFT_CONSTANT(btck_BlockValidationResult_INVALID_PREV)
BTCK_SWIFT_CONSTANT(btck_BlockValidationResult_TIME_FUTURE)
BTCK_SWIFT_CONSTANT(btck_BlockValidationResult_HEADER_LOW_WORK)
...
BTCK_SWIFT_CONSTANT(btck_TxValidationResult_CONSENSUS)
